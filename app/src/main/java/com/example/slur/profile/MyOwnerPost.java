...
public class MyOwnerPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_owner_post);
        ...
        responseListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    postAdapter = new PostAdapter(PostitemModels, MyOwnerPost.this, user_id);
                    Log.d("냠냠냠", "어댑터");
        ...
        MyOwnerPostRequest myPost = new MyOwnerPostRequest(user_id, responseListener);
        RequestQueue queue = Volley.newRequestQueue(MyOwnerPost.this);
        queue.add(myPost);
