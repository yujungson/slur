...
public class MyPostTypeSelect extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_post_type_select);
        ...
        ownerPost.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyPostTypeSelect.this, MyOwnerPost.class);
        ...
        playerPost.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyPostTypeSelect.this, MyPlayerPost.class);
                intent.putExtra("user_id", user_id);
                startActivity(intent);
                finish();
            }
