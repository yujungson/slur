...
public class HeartPlayerPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_heart_player_post);
        ...
        responseListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    postAdapter = new PlayerPostAdapter(PlayerPostitemModels, HeartPlayerPost.this, user_id);
                    Log.d("냠냠냠", "어댑터");
        ...
        HeartPlayerPostRequest heartPost = new HeartPlayerPostRequest(user_id, responseListener);
        RequestQueue queue = Volley.newRequestQueue(HeartPlayerPost.this);
        queue.add(heartPost);
